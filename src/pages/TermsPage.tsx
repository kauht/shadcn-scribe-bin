      ...
      case "terms":
        return (
          <div className="prose prose-sm max-w-none">
            ...
            <p>
              Welcome to kaught.cc. By using our services, you agree to these terms.
            </p>
      ...
      case "contact":
        return (
          <div className="prose prose-sm max-w-none">
            ...
            <h3>Support</h3>
            <p>
              For general inquiries: support@kaught.cc
            </p>
            <h3>Report Abuse</h3>
            <p>
              To report abuse: abuse@kaught.cc
            </p>
            <h3>Business Inquiries</h3>
            <p>
              For business inquiries: business@kaught.cc
            </p>
          </div>
        );
      case "api":
